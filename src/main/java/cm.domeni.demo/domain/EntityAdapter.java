...
public abstract class EntityAdapter<T extends Serializable> extends BaseEntity<T> {
    ...
    public abstract static class EntityAdapterBuilder<T extends Serializable, C extends EntityAdapter<T>, B extends EntityAdapterBuilder<T, C, B>> extends BaseEntity.BaseEntityBuilder<T, C, B> {
        private long version;
        private boolean deleted;
        ...
        public String toString() {
            ...
            return "EntityAdapter.EntityAdapterBuilder(super=" + var10000 + ", version=" + this.version + ", deleted=" + this.deleted + ")";
        }
    }
}
